...
from src.protocol_emulate import *
...
class SocketListener((SocketServer.BaseRequestHandler)):
    ...
    def setup(self):
        # send random length garbage to the attacker
 ...
 # fake_string = random number between 5 and 30,000 then os.urandom the command back
            # Only use fake strings for protocols that are not covered by protocol_emulate
